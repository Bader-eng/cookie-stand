...
for(let i=0;i<hours.length;i++){
  let simulatedamounts=Seattle.avg_cookie_sale*Seattle.generaterandomnumber(65,23);
...
let simulatedarray1=[];
for(let i=0;i<hours.length;i++){
  let simulatedamounts1=Tokyo.avg_cookie_sale1*Tokyo.generaterandomnumber(24,3);
...
let simulatedarray2=[];
for(let i=0;i<hours.length;i++){
  let simulatedamounts2=Dubai.avg_cookie_sale1*Dubai.generaterandomnumber(38,11);
...
let simulatedarray3=[];
for(let i=0;i<hours.length;i++){
  let simulatedamounts3=Paris.avg_cookie_sale1*Paris.generaterandomnumber(38,20);
...
orderlist=document.createElement('li');
orderlist.innerText='total:'+Paris.total2+'cookies';
unorderdlist.appendChild(orderlist);
main.appendChild(unorderdlist);
...
let simulatedarray4=[];
for(let i=0;i<hours.length;i++){
  let simulatedamounts4=Lima.avg_cookie_sale1*Lima.generaterandomnumber(38,20);
...
orderlist=document.createElement('li');
orderlist.innerText='total:'+Lima.total2+'cookies';
unorderdlist.appendChild(orderlist);
main.appendChild(unorderdlist);
